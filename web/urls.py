...
from web.views.events import event_detail, event_list, event_registrations, \
    event_emergency_contacts, event_emails_copied, calendar_view, events_redirect
...
urlpatterns = [
    ...
    path('events/<int:event_id>/registrations/emails-copied', event_emails_copied, name='event_emails_copied'),
